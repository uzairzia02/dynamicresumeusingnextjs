...
export default function WorkHistory() {
  ...
  // Load saved work experiences from localStorage (only runs on client)
  useEffect(() => {
    ...
    <>
      ...
      <div className="w-full 2xl:w-[1240px] mx-auto p-4 md:p-6 lg:p-8 min-h-screen">
        ...
        {experiences.map((exp, idx) => (
          <div
            key={idx}
            className="w-full lg:w-[1000px] px-0 lg:px-10 mt-5 mb-10 border-b border-blue-100 pb-8"
          >
        ...
        <div className="mt-8 md:mt-10 flex flex-col sm:flex-row justify-end gap-4 sm:gap-6 lg:gap-12 pb-5">
          ...
          <button
            ...
            className="w-full sm:w-auto border-4 border-blue-600 hover:text-white text-blue-600 hover:bg-blue-600 duration-200 px-6 md:px-8 lg:px-10 py-2 md:py-3 font-bold rounded-full"
          >
            Add More Experience
          </button>
